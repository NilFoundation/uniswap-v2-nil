...
.setAction(async (taskArgs, hre) => {
    ...
    await currencyContract.sendCurrencyInternal(taskArgs.to, currencyId, BigInt(amount));
    ...
    const recipientBalance = await currencyContract.getCurrencyBalanceOf(taskArgs.to);
