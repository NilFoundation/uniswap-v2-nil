...
import {Token, UniswapV2Pair, Wallet} from '../typechain-types';
...
task("burn", "Burn liquidity tokens and print balances and reserves")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log("Pair Balance token0 after burn:", pairBalanceToken0.toString());
        console.log("Pair Balance token1 after burn:", pairBalanceToken1.toString());
        ...
        const balanceToken0 = await token0Contract.getCurrencyBalanceOf(walletAddress.toLowerCase())
        const balanceToken1 = await token1Contract.getCurrencyBalanceOf(walletAddress.toLowerCase())
