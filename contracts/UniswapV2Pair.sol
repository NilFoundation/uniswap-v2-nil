...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function initialize(address _token0, address _token1) external {
        ...
        lpToken = tokenLib.newToken(string(abi.encodePacked(token0Name, '-', token1Name)), 'LP', 18, 0, address(this));
    }
    ...
    function skim(address to) external lock {
        address _token0 = token0; // gas savings
        address _token1 = token1; // gas savings
        _safeTransfer(_token0, to, tokenLib.balanceOf(_token0, address(this)).sub(reserve0));
        _safeTransfer(_token1, to, tokenLib.balanceOf(_token1, address(this)).sub(reserve1));
    }
